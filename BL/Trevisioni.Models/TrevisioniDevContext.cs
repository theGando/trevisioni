...
{
    public partial class TrevisioniDevContext : DbContext
    {
        public TrevisioniDevContext()
        {
        }

        public TrevisioniDevContext(DbContextOptions<TrevisioniDevContext> options)
            : base(options)
        {
        }
